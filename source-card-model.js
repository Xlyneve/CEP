export const sourceCardDefinitions = {
  'PN.html': { card: 'note-card', title: 'note-title', body: 'note-content', meta: '', image: 'note-image', url: 'note-url', container: 'nurseNotesList', imageAfter: true, dateField: 'time', copy: 'plain-normalized' },
  'info.html': { card: 'note-card', title: 'note-title', body: 'note-text', meta: 'timestamp', image: '', url: 'note-url', container: 'notesContainer', imageFirst: true, urlBefore: true, dateField: 'timestamp', datePrefix: 'Added: ', copy: 'plain' },
  'explain.html': { card: 'note-card', title: 'note-title', body: 'note-text', meta: 'timestamp', container: 'notesContainer', dateField: 'timestamp', datePrefix: 'Saved on ', copy: 'rich' },
  'recalls.html': { imageAfter: true, image: 'zoomable', card: 'note-card', title: 'note-title', body: 'note-content', meta: '', url: 'note-url', container: 'nurseNotesList', dateField: 'time', copy: 'plain-normalized' },
  'practiceN.html': { card: 'note-card', title: 'note-title', body: 'note-text', meta: 'timestamp', url: 'note-url', container: 'notesContainer', urlBefore: true, dateField: 'timestamp', datePrefix: 'Added: ', copy: 'plain' },
